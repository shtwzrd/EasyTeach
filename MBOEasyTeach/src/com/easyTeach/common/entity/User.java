 ...
 * database. A User could be an administrator, a teacher or a student. 
 * The class contains getters and setters for the seven attributes derived 
 * from the User table, namely; userNo, email, userType, firstName, lastName,
 * password and dateAdded.
 * </p>
 * 
 * <p>
